...
export const allRoutes = [
    ...
    new Route("/loginPost", "loginPost", "/php/authentif/loginPost.php", ["disconnected"]),
    new Route("/deconnexion", "Déconnexion", "/php/authentif/deconnexion.php", ["admin", "employe", "chauffeur", "passager", "les2"]),
    new Route("/creation-cpt", "Création de compte", "/pages/authentif/creation-cpt.html", [], "/js/authentif/creation-cpte.js"),
    new Route("/inscription", "Inscription", "/php/authentif/inscription.php", []),
    new Route("/modifier-mp", "Modifier mon mot de passe", "/pages/authentif/modifier-mp.html", [], "/js/authentif/modifier-mp.js"),
    new Route("/espace-user", "Espace utilisateur", "/pages/user/creat-espace-user.html", [], "/js/user/espace-user.js"),
    new Route("/creat-user", "creation user", "/php/users/creat-user.php", []),
    new Route("/profil", "Profil utilisateur", "/php/users/profil.php", ["admin", "employe", "chauffeur", "passager", "les2"]),
