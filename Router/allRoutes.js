...
export const allRoutes = [
    ...
    new Route("/contact", "contact", "/pages/visiteur/contact.html", "/js/authentif/contact.js"),
    ...
    new Route("/espace-user", "Espace utilisateur", "/pages/user/espace-user.html", "/js/authentif/espace-user.js"),
