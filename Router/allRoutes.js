...
export const allRoutes = [
    ...
    new Route("/modifMp", "Modifier mon mot de passe", "/php/authentif/modifMp.php", [],),
    new Route("/creat-user", "Espace utilisateur", "/pages/user/creat-user.html", [], "/js/user/espace-user.js"),
    new Route("/new-user", "Création utilisateur", "/php/users/new-user.php", ["admin", "employe", "chauffeur", "passager", "les2"]),
    new Route("/profil", "Profil utilisateur", "/pages/user/profil.php", ["admin", "employe", "chauffeur", "passager", "les2"]),
    new Route("/conex-profil", "Profil utilisateur", "/php/users/conex-profil.php", ["admin", "employe", "chauffeur", "passager", "les2"]),
