...
["User"] -> Réserver aux utilisateurs avec le rôle chauffeur-passager (Les 2)
...
["admin", "employe", "chauffeur", "passager", "user"] -> Réserver aux utilisateurs avec le rôle admin OU employé OU chauffeur OU passager OU user
*/
